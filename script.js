...
var event_item = document.querySelectorAll(
  ".events .events-bottom .events-item"
);
var event_button = document.querySelectorAll(
  ".events .events-bottom .events-item .events-info .events-info-expand"
);
...
function getEventItem() {
  ...
  event_button = document.querySelectorAll(
    ".events .events-bottom .events-item .events-info .events-info-expand"
  );
